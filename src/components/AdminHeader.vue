  ...
  <header class="header">
    <div class="header-content">
      ...
      <nav class="navigation">
        ...
        <div
          class="nav-item"
          :style="styleNavItem('/admin/users')"
          @click="goTo('/admin/users')"
          @mouseover="addHoverEvent(event, (path = '/admin/users'))"
          @mouseout="removeHoverEvent(event, (path = '/admin/users'))"
        >
          <TeamOutlined style="padding-right: 8%" />
          Người dùng
        </div>

        <div
          class="nav-item"
          :style="styleNavItem('/admin/problems')"
          @click="goTo('/admin/problems')"
          @mouseover="addHoverEvent(event, (path = '/admin/problems'))"
          @mouseout="removeHoverEvent(event, (path = '/admin/problems'))"
        >
          <ReadOutlined style="padding-right: 10%" />
          Bài tập
        </div>

        <div
          class="nav-item"
          :style="styleNavItem('/admin/settings')"
          @click="goTo('/admin/settings')"
          @mouseover="addHoverEvent(event, (path = '/admin/settings'))"
          @mouseout="removeHoverEvent(event, (path = '/admin/settings'))"
        >
        ...
        <div
          class="nav-item"
          :style="styleNavItem('/admin/status')"
          @click="goTo('/admin/status')"
          @mouseover="addHoverEvent(event, (path = '/admin/status'))"
          @mouseout="removeHoverEvent(event, (path = '/admin/status'))"
        >
          <FieldTimeOutlined style="padding-right: 8%" />
          Bài nộp
        </div>

        <div
          class="nav-item"
          :style="styleNavItem('/admin/ranking')"
          @click="goTo('/admin/ranking')"
          @mouseover="addHoverEvent(event, (path = '/admin/ranking'))"
          @mouseout="removeHoverEvent(event, (path = '/admin/ranking'))"
        >
      ...
      <div class="user-actions">
        ...
        <img src="../static/img/icon_vn.svg" />
